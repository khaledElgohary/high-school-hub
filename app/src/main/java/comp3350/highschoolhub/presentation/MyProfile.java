    ...
    private void buttonHandler(EditText text,ImageButton btn,boolean flag) {
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //below boolean is used for checking if the correct format for the user name is inputted
                ...
                if (save > 1) {
                    ...
                    if (flag) {
                        if(text.getText().toString().split(" ").length==1){
                            checkName=false;
                            Toast.makeText(getApplicationContext(),"User name should contain first, and last name.",Toast.LENGTH_SHORT).show();
                        }
                        else{
